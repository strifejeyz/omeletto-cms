...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/backend/overrides.css">
...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="/" class="brand-link">
            <img src="/assets/img/strife-heading.png" alt="AdminLTE Logo" class="brand-image img-circle"
                 style="opacity: .8">
            <span class="brand-text font-weight-light">Omeletto<b style="font-family: cursive">CMS</b></span>
        </a>
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{r('cms.users.index')}}" class="nav-link">
                                    <i class="far fa-user-circle nav-icon"></i>
                                    <p>Users</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{r('cms.users.create')}}" class="nav-link">
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{r('cms.articles.index')}}" class="nav-link">
                                    <i class="far fa-newspaper nav-icon"></i>
                                    <p>Articles</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{r('cms.articles.create')}}" class="nav-link">
                                    <i class="far fa-plus-square nav-icon"></i>
                                    <p>New Article...</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{r('cms.media.index')}}" class="nav-link">
                                    <i class="far fa-plus-square nav-icon"></i>
                                    <p>Files</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{r('cms.media.upload')}}" class="nav-link">
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">{!$title!}
                            {if isset($subtitle)}<br>
                                <small style="font-size:14px;position:relative;top:-10px">{!@$subtitle!}</small>
                            {endif}
                        </h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
